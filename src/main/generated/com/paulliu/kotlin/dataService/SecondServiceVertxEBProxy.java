...
public class SecondServiceVertxEBProxy implements SecondService {
  ...
  public SecondServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public SecondServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public SecondService insertOther(JsonArray para, Handler<AsyncResult<Boolean>> resultHandle) {
    ...
    _deliveryOptions.addHeader("action", "insertOther");
